...
/***/ function(module, exports) {
	...
	* @Last Modified time: 2017-03-10 16:24:47
	*/
	...
	function showCloseIcon() {
	    var $close_icon = document.querySelector("#left-col-close");
	...
	function hideLeft() {
	    var $left_col = document.querySelector(".left-col");
	    var $left_col_class = $left_col.getAttribute("class");
	    $left_col.setAttribute("class", $left_col_class + " hide");
	    var $mid_col = document.querySelector(".mid-col");
	    var $mid_col_class = $mid_col.getAttribute("class");
	    $mid_col.setAttribute("class", $mid_col_class + " left-hide");
	    var $tools_col = document.querySelector(".tools-col");
	    var $left_col_open = document.querySelector("#left-col-open");
	    $left_col_open.style.display = "block";
	}

	function openLeft() {
	    var $left_col = document.querySelector(".left-col");
	    var $left_col_class = $left_col.getAttribute("class").replace(" hide", "");
	    $left_col.setAttribute("class", $left_col_class);
	    var $mid_col = document.querySelector(".mid-col");
	    var $mid_col_class = $mid_col.getAttribute("class").replace(" left-hide", "");
	...
	var init = function init() {
	    ...
	    var $left_col_close = document.querySelector("#left-col-close");
